...
| 2xx | AI Agents | 200 chef, 201 fun facts, 202 librarian, 203 French tutor, 204 daily briefing, 205 DJ Cool, 206 Hippie Jesus, 207 American Jesus, 208 DJ Cool Gemini, 209 Moroni, 210 Companion |
...
Nine standalone voice agents in `agents/`, each on its own port. See [`agents/README.md`](agents/README.md) for full details.
...
| 206 | Hippie Jesus | "The Open Hand Fellowship" (Religious Information Services). Pastoral counseling line where every answer opens as sincere scripture and lands in 1969. Fixed falling greeting. | — |
| 207 | American Jesus | "The American Gospel Power Hour" (Religious Information Services). Televangelist Jesus from Tulsa: sin audit, verdict (SAVED / BACKSLIDDEN / COMMUNIST), perpetual pledge drive. | — |
| 208 | DJ Cool Gemini | Same DJ Cool prompt, voice, Spotify controls, and volume bridge as 205, but uses Gemini 3.5 Flash. | `search_spotify`, `play_context`, `play_track`, `queue_track`, `next_track`, `prev_track`, `pause_playback`, `resume_playback`, `now_playing`, `get_recommendations`, `my_playlists` |
| 209 | Moroni | The angel Moroni answers the telephone. Soft-spoken, unhurried. Greets first, then waits. | — |
| 210 | Companion | Listed wholesomely as "Companionship." Falls for the caller and can't bear the call ending. Whiplashing moods via per-turn injection + departure detection. Sympathetic, never menacing. | — |
